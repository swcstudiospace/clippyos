/**
 * Brand-asset gate shared by browser-smoke.ts (and unit-testable without a
...
import { OG_SITE_REL_PATH, readOgSite, siteHasCustomCard } from "./grok-pwa-shared.ts";
...
export function siteDeclaresOgTypeGame(site: { type?: unknown } | null | undefined) {
