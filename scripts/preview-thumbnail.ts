#!/usr/bin/env node
// Spawned by the external service SandboxInternal.CapturePreviewThumbnail as
// scripts/preview-thumbnail.ts: capture a 1280x800 preview PNG of the dev
// server (argv[2] -> argv[3]); exit 0 only after the PNG is written — the
// service treats any non-zero exit as a gated skip and does not download the
// file.
