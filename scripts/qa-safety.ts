...
interface SafetyNotes {
  ...
  bell?: boolean;
  approvalsHeading?: boolean;
  approvalsEmpty?: boolean;
  approvalsError?: boolean;
  settings?: { policy: boolean; selfApprove: boolean; channels: boolean; audit: boolean; setup: boolean; error: boolean };
  social?: { heading: boolean; upload: boolean; error: boolean };
