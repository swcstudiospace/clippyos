//#region node_modules/.nitro/vite/services/ssr/assets/integrations-BBMsU168.js
var INTEGRATION_IDS = [
	"ai",
	"higgsfield",
	"youtube",
...
var BANNER_BY_PATH = [
	{
		match: (path) => path.startsWith("/ideation") || path.startsWith("/agent") || path.startsWith("/thumbnails") || path.startsWith("/clients"),
		id: "ai"
	},
	{
		match: (path) => path.startsWith("/thumbnails") || path.startsWith("/agent"),
		id: "higgsfield"
	},
	{
	...
	{
		match: (path) => path.startsWith("/social") || path.startsWith("/agent"),
		id: "daytona"
	},
	{
...
function healthTone(health) {
	switch (health) {
		...
		case "token_expired": return "orange";
		case "saved": return "blue";
		default: return "neutral";
	}
}
//#endregion
export { healthLabel as a, INTEGRATION_IDS as i, INTEGRATIONS_QUERY_KEY as n, healthTone as o, INTEGRATION_COPY as r, BANNER_BY_PATH as t };
