...
//#region node_modules/.nitro/vite/services/ssr/assets/client-C4IS_tWT.js
var client_C4IS_tWT_exports = /* @__PURE__ */ __exportAll({
	a: () => signIn,
	i: () => setPreviewSessionToken,
	n: () => client_exports,
	o: () => signOut,
	r: () => getBearerToken,
	t: () => authClient
...
var client_exports = /* @__PURE__ */ __exportAll$1({
	...
	setPreviewSessionToken: () => setPreviewSessionToken,
	signIn: () => signIn,
	signOut: () => signOut
});
/**
...
function setPreviewSessionToken(token) {
...
//#endregion
export { signIn as a, setPreviewSessionToken as i, client_C4IS_tWT_exports as n, signOut as o, getBearerToken as r, authClient as t };
