...
export const MCP_TOOLS: readonly McpToolDef[] = [
  ...
  },
  {
    ...
    domain: "Crayo",
    description: "Crayo plan, credit balances, and storage. Never returns the API key.",
    scopes: ["read"],
  },
  {
    name: "crayo.list_assets",
    domain: "Crayo",
    description: "List Crayo library assets (url, duration, thumbnail).",
    scopes: ["read"],
  },
  {
    name: "crayo.list_voices",
    domain: "Crayo",
    description: "List narration voices. voice_id is required for generate_voiceover.",
    scopes: ["read"],
  },
  {
    name: "crayo.import_asset",
    domain: "Crayo",
    description: "Import a public https file into the Crayo library.",
    scopes: ["actions:ai"],
  },
  {
    name: "crayo.generate_image",
    domain: "Crayo",
    description: "Generate a still (1 image credit). Prefer 9:16 for shorts.",
    scopes: ["actions:ai"],
  },
  {
    name: "crayo.generate_voiceover",
    domain: "Crayo",
    description: "TTS from script + voice_id. Charges voiceover credits per second.",
    scopes: ["actions:ai"],
  },
  {
    name: "crayo.create_project",
    domain: "Crayo",
    description: "Compose scenes + optional narration/music/subtitles. Free until export.",
    scopes: ["actions:ai"],
  },
  {
    name: "crayo.export_project",
    domain: "Crayo",
    description: "Queue a render (1 export credit/sec) and poll until the video URL is ready.",
    scopes: ["actions:ai"],
  },
  {
    name: "crayo.get_export",
    domain: "Crayo",
    description: "Poll one export. completed includes the downloadable asset url.",
    scopes: ["read"],
  },
  {
    name: "crayo.create_autoclip",
    domain: "Crayo",
    description: "Cut a long video asset into vertical shorts. 1 video credit per requested clip.",
    scopes: ["actions:ai"],
  },
  {
    name: "crayo.get_autoclip",
    domain: "Crayo",
    description: "Read AutoClip job status and finished clip project_ids / thumbnails.",
    scopes: ["read"],
  },
  {
    name: "crayo.ingest_to_library",
    domain: "Crayo",
    description: "Download a Crayo CDN https file into the Filebase library (source=AGENT, tags crayo,agent). Never stores the API key.",
    scopes: ["actions:ai"],
  },
  {
    name: "crayo.run_short",
    domain: "Crayo",
    description: "Full 9:16 short pipeline (credits → image → voice → project → export) then ingest the mp4 into the library.",
    scopes: ["actions:ai"],
  },
  {
    name: "crayo.run_autoclip",
    domain: "Crayo",
    description: "Import a long-form https URL, AutoClip, ingest clip thumbnails into the Filebase library.",
    scopes: ["actions:ai"],
  },
  {
